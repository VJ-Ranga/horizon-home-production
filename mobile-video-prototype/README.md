...
Each section plays a short timestamp range from `public/video-mobile/haycarb-540x960.mp4`, then freezes at the matching portrait frame and leaves the content as normal HTML. Nothing in `src/` imports this folder.
