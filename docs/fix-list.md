...
- [x] Keep the Section 16 reader available throughout the compact section lifecycle.
- [x] Prevent Lenis from being blocked while the mobile reader is temporarily not scrollable.
- [x] Allow the intro and all four cards to scroll down reliably on small phones.
- [x] Release the page normally at the reader bottom for the Section 17 handoff.
- [x] Do not change Section 16 desktop behavior.
